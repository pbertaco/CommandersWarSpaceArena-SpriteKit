...
extension GameColors {
    ...
    static let points = #colorLiteral(red: 0.9058823529, green: 0.662745098, blue: 0.2470588235, alpha: 1)
    static let premiumPoints = #colorLiteral(red: 0, green: 0.6078431373, blue: 0.8862745098, alpha: 1)
